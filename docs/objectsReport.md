...
export type Repository = {
  ...
  TLG: {                              // ← Custom app-specific field
    tracking: boolean;
    daysActiveCommitts: string[];     // Array of dates with commits
...
- Added `TLG` object containing:
  ...
  - `daysActiveCommitts`: extracted from commit history
...
```typescript
{
  ...
  TLG: {
    tracking: true,
    daysActiveCommitts: ["2024-01-15", "2024-01-16", ...],
    articles: [
      {
        title: "my-awesome-project - Authentication Enhancements",
        date: "2024-01-15",
